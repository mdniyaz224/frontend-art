...
Concept-by-concept reference for the COSYPOS frontend. Each doc covers one part of the system: what it does, why it's built that way, and where the code lives. Mirrors the structure of `be-boiler`'s own `docs/`.
